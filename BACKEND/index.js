...
const stripe = require("stripe")(
  "sk_test_51K93ltBcGooWtax9GkAGLr4DEmlZNpm6tUa0SLImClKgGZFpYehHv9XhvOAf5escrbFzko1UJ1bbecG02hdCCZZu00K0yXRB8H"
);
...
async function run() {
  ...
  try {
    ...
    app.delete("/tour/:id", async (req, res) => {
      const id = req.params.id;
      const query = { _id: ObjectId(id) };
      const result = await ourPlaces.deleteOne(query);
      res.json(result);
    });

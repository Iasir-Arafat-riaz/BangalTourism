      ...
      <div className="loginContainer">
        <div className="form-container">
          <div className="box signIn">
            <h3 className="ms-5 mb-5 mb-md-0 ms-md-0">
        ...
        <div id="formBox">
          <div className="form signinForm">
            <form onSubmit={handalelogin}>
              ...
              <h3>Sign In</h3>
              <input
                onChange={userLoginEmail}
                type="email"
                placeholder="Enter your Email"
              />
              <input
                onChange={userLoginPassword}
                type="password"
                placeholder="Enter your Password"
              />
              {/* <button >Sign Out</button> */}
              <input type="submit" value="Sign In" className=" p-2 submitBtn" />
              <br />
              <br />
              <br />
              <small className="d-none d-md-block text-center fw-bold">
                ------ Or sign in with ------
              </small>
              <aside className="SocialIcon">
                <Button
                  className="SignMethod"
                  onClick={() => handaleGoogleSign(location, navigate)}
                >
                  Google Sign In
                </Button>
              </aside>
